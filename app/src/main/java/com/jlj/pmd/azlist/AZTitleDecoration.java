...
//		mBackgroundPaint.setColor(mTitleAttributes.mBackgroundColor);
		mBackgroundPaint.setColor(ResourceUtil.getColor(mTitleAttributes.mContext,R.color.share_gray));
	...
	public static class TitleAttributes {
		...
		public TitleAttributes(Context context) {
			...
			mTextPadding = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, context.getResources().getDisplayMetrics());
			mTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 14, context.getResources().getDisplayMetrics());
			mTextColor = ResourceUtil.getColor(context,R.color.text_blue2);
			mBackgroundColor = ResourceUtil.getColor(context,R.color.white);
		}
