...
public class RangeSeekbar extends View {
    ...
    private void initData() {
        if (mTextArray == null || mTextArray.length == 0) {
            mTextArray = new String[]{"1", "5", "10", "15", "20", "25", "30", "35", "40", "45", "50"};
        }
        mLeftCursorIndex = 0;
...
//        mPaddingRect.top = (int) (PADDING_TOP * mDensity + getPaddingTop() + 0.5f);
    ...
    private void applyConfig(Context context, AttributeSet attrs) {
        ...
        if (mLeftCursorBG == null)
            mLeftCursorBG = context.getResources().getDrawable(R.mipmap.ic_launcher);
        if (mRightCursorBG == null)
            mRightCursorBG = context.getResources().getDrawable(R.mipmap.ic_launcher);

        mTextColorNormal = a.getColor(R.styleable.RangeSeekbar_textColorNormal, Color.parseColor("#F5AF3B"));
        mTextColorSelected = a.getColor(R.styleable.RangeSeekbar_textColorSelected, Color.parseColor("#F5AF3B"));
        mSeekbarColorSelected = a.getColor(R.styleable.RangeSeekbar_seekbarColorSelected, Color.parseColor("#F5AF3B"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("", textDrawLeft0, textDrawBottom0, mPaint);
        ...
        final int rightTop = (int)(mSeekbarRect.bottom + mGap + 0.5f);// mPaddingRect.top * 6;
...
//        mPaint.setTextSize(mTextSize);
        ...
        canvas.drawText("", textDrawLeft1, textDrawBottom1, mPaint);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                EventBus.getDefault().post(new RangBarEvent(((int) mLeftCursorIndex), (int) mRightCursorIndex, 1));
                break;
...
//                }
            ...
            EventBus.getDefault().post(new RangBarEvent(((int) mLeftCursorIndex), (int) mRightCursorIndex, 2));
//            }
